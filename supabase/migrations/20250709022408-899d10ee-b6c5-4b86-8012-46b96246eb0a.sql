...
CREATE TYPE communication_type AS ENUM ('email', 'sms', 'call');
...
CREATE INDEX idx_sequence_steps_order ON public.sequence_steps(step_order);
...
-- Insert default email templates (SREQ-001, 002, 005, 006)
...
Namaste,
The Talo Yoga Team', 'welcome', 'general', 2),
...
With love and light,
The Talo Yoga Team', 'welcome', 'prenatal', 2),
...
Peace and light,
The Talo Yoga Team', 'follow-up', 'general', 72),
...
With gratitude,
The Talo Yoga Team', 're-engagement', 'general', 0);

-- Insert default communication sequences (SREQ-002, 005)
INSERT INTO public.communication_sequences (name, description, trigger_type, segment) VALUES
('New Lead Follow-up Sequence', '3 touchpoints over 7 days for new prospects', 'new-lead', 'general'),
('Re-engagement Campaign', 'Win-back sequence for inactive customers', 'inactive-90-days', 'general');